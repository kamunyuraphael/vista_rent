...
import { ROUTES, bookingPath } from "../routes";
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-32 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-primary/30 bg-primary/10 mb-6">
              ...
              <span className="text-xs font-semibold text-primary tracking-wide uppercase">Nairobi's Premium Fleet</span>
            </div>
            <h1
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <GhostBtn to={ROUTES.services}>
                Corporate Accounts <ChevronDown size={14} className="rotate-[-90deg]" />
              </GhostBtn>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-6 mb-28">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {vehicles.slice(0, 3).map((v) => (
            <VehicleCard key={v.id} vehicle={v} reserveTo={bookingPath(v.id)} />
          ))}
        </div>
      ...
      <section className="bg-card border-y border-border py-24 mb-0">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {testimonials.map((t) => (
              <div key={t.name} className="bg-secondary border border-border rounded-xl p-6">
